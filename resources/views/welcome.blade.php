...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="relative bg-[#FDFDFC] text-[#1b1b18] flex items-center lg:justify-center min-h-screen flex-col">
        <!-- <header class="w-full text-sm mb-6 not-has-[nav]:hidden">
            @if (Route::has('login'))
                <nav class="flex items-center justify-between gap-4">
                    <a href="/">YENBANGUNAN <span>TM</span></a>
                    <ul class="flex justify-content gap-8">
                        <li>Home</li>
                        <li>Product</li>
                        <li>About Us</li>
                        <li>Blog</li>
        ...
        <div class="w-full h-screen grid content-center p-8 bg-black text-white">
            <nav class="fixed w-full z-40 top-0 start-0 text-white">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-1 px-2">
                    ...
                    <div class="bg-white text-black font-special-gothic items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                        ...
                        <li>
                            <a href="#" class="block py-2 px-3 text-heading rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-fg-brand md:p-0 md:dark:hover:bg-transparent">About Us</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-3 text-heading rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-fg-brand md:p-0 md:dark:hover:bg-transparent">Blog</a>
                        </li>
                        </ul>
                    </div>
                </div>
