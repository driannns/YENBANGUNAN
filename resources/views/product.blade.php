...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="relative bg-[#FDFDFC] text-[#1b1b18] flex items-center lg:justify-center min-h-screen flex-col">
        ...
        <div class="relative w-full h-screen grid content-center p-8 text-white" style="background-image: url('/assets/product-background.jpg'); background-size: cover; background-position: center; margin-top: 3.2rem">
