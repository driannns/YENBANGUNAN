...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="relative bg-[#FDFDFC] text-[#1b1b18] flex items-center lg:justify-center min-h-screen flex-col">
        ...
        <nav class="w-full z-40 bg-black text-white p-1 font-d-din uppercase" style="margin-top: 3.7rem">
            <div class="flex flex-wrap items-center justify-between mx-auto py-1 px-2">
                ...
                <div class="bg-white md:bg-transparent lg:bg-transparent md:text-white lg:text-white text-black font-special-gothic items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
        ...
        <div class="w-full flex flex-col text-white md:flex-row">
            <div style="background-image: url('{{ asset('assets/aboutus-wallpaper.jpg') }}'); height: 80vh;" class="hidden md:block w-full md:w-2/3 bg-right-top bg-cover bg-no-repeat">
                <img src="{{ asset('assets/aboutus-wallpaper-2.jpeg') }}" alt="About Us Wallpaper" class="invisible">
            </div>
            <div style="background-image: url('{{ asset('assets/aboutus-wallpaper-2.jpeg') }}'); height: 80vh;" class="lg:hidden md:invisibhiddenle w-full md:w-2/3 bg-right-top bg-cover bg-no-repeat">
                <img src="{{ asset('assets/aboutus-wallpaper-2.jpeg') }}" alt="About Us Wallpaper" class="invisible">
            </div>
            <div class="relative bg-black py-10 px-8 font-montserrat md:w-1/3">
                <div class="md:absolute md:top-1/2 md:-translate-y-1/2 md:-left-1/2 bg-white text-black px-4 py-20 w-full">
                    <h1 class="text-3xl font-extrabold">About Us</h1>
                    <p class="mt-2 leading-7 text-sm font-medium">
                        PT Yen Sejahtera, berdiri sejak 2008 di Cikarang, memfokuskan diri pada 
                        perdagangan material bangunan dan distribusi kebutuhan pabrik di Bekasi, Cikarang, 
                        dan Karawang. Kami berkomitmen memberikan produk dan layanan terbaik, termasuk material 
                        bangunan, listrik/elektronik, dan kebutuhan industri lainnya, dengan kepuasan pelanggan 
                        menjadi prioritas utama.
                    </p>
                    <div class="flex items-center gap-4 mt-4">
                        <div class="w-3/12">
                            <img src="{{ asset('assets/map.png') }}" alt="Yen Bangunan Map">
                        </div>
                        <div class="text-xs">
                            <p><span class="font-bold">Jam Operasional:</span> 07:30 WIB – 20:00 WIB (Senin-minggu)</p>
                            <p><span class="font-bold">Lokasi:</span> Lippo Cikarang, Sukadami, Cikarang Selatan, Bekasi Regency, West Java 17530</p>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div style="height: 30vh;" class="grid place-items-center border-b border-gray-300">
            <h1 class="text-3xl font-extrabold font-montserrat text-center">“YEN BANGUNAN <span class="text-[#e58039]">ONE STOP SOLUTION</span> UNTUK SEGALA KEBUTUHAN ANDA”</h1>
        </div>

        <div class="my-10 p-10 flex flex-col md:flex-row md:items-center gap-10">
            <div class="w-full md:w-1/2">
                <img src="{{ asset('assets/logo.png') }}" alt="Yen Bangunan Logo" class="invert w-2/3 mx-auto">
            </div>
            <div class="font-montserrat flex flex-col gap-6 lg:gap-10">
                <div class="pb-4 border-b border-gray-300">
                    <h1 class="text-xl font-bold">Solusi Satu Atap:</h1>
                    <p>Menjadi solusi lengkap dengan menyediakan semua kebutuhan dalam satu tempat.</p>
                </div>
                <div class="pb-4 border-b border-gray-300">
                    <h1 class="text-xl font-bold">Kemitraan yang Kuat:</h1>
                    <p>Membangun hubungan kuat dengan pemasok dan mintra bisnis untuk pasokan produk yang konsisten</p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-4 w-full font-montserrat">
            <h1 class="text-xl font-extrabold uppercase text-center">Customer Service</h1>
            <p class="mt-4 text-center">Bingung soal kebutuhan bangunan Anda? Konsultasikan dengan tim YenBangunan via WhatsApp - gratis dan cepat!
            </p>
        </div>
        ...
        <footer class="bg-black text-white">
            ...
            <div class="w-full border-t border-white flex items-center gap-5 justify-center p-3">
                <img src="{{ asset('assets/logo.png') }}" alt="Logo" class="w-1/12">
