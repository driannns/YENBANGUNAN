...
<head>
    ...
    <style>
        ...
        .wp-block-list {
            list-style: disc;
            margin: 0 0 1.5em 1.5em m !important;
        }
...
@include('partials.gtm-body')
    ...
    <main class="w-full px-4 py-8 sm:px-6 md:px-10 md:py-10" style="margin-top: 76px">
        <div class="max-w-7xl mx-auto reveal">
            ...
            <div class="">
                <h1 class="text-2xl font-bold mb-4">Yen Bangunan Cikarang</h1>
            ...
            <p class="mt-3"><strong>Yen Bangunan Cikarang</strong> (PT Yen Sejahtera) adalah <strong>toko bangunan terbesar dan terlengkap di Cikarang</strong>, yang sejak 2008 hadir sebagai <strong>one-stop solution untuk kontraktor, developer, dan kebutuhan industri</strong> di Bekasi, Cikarang, dan Karawang</p>
            <h1 class="text-xl font-bold my-2">Profil Perusahaan & Layanan Utama</h1>
            <p>Dengan pengalaman lebih dari 15 tahun, Yen Bangunan menghadirkan:</p>
            <ul class="list-disc list-inside my-2">
                <li>Lebih dari 5.000 SKU produk, mencakup material seperti semen, besi, baja ringan, cat, keramik, alat teknik & kebutuhan industri.</li>
                <li>Telah melayani 700+ proyek dan puluhan perusahaan industri/pabrik di kawasan Cikarang & sekitarnya</li>
            </ul>
            <h1 class="text-xl font-bold my-2">Keunggulan Layanan & Fitur</h1>
            <ul class="list-disc list-inside my-2">
                <li><strong>Free Delivery area Cikarang</strong> — memudahkan pengiriman langsung ke lokasi proyek tanpa biaya ekstra.</li>
                <li><strong>Layanan Request Order</strong>, menyediakan layanan pemesanan khusus untuk kebutuhan volume besar baik material proyek maupun kebutuhan pabrik.</li>
    ...
    <script>
        (function () {
            ...
            // threshold di sini SENGAJA 0, bukan 0.1 seperti di halaman lain.
            // .reveal di halaman ini membungkus seluruh isi artikel (tinggi
            // elemennya beda-beda tergantung panjang konten) — threshold 0.1
            // butuh 10% dari TINGGI ELEMEN ITU SENDIRI kelihatan sebelum
            // callback jalan. Untuk artikel panjang (>10x tinggi viewport),
            // angka itu tidak akan pernah tercapai walau sudah di-scroll,
            // jadi kontennya nyangkut permanen di opacity:0 — paling kerasa
            // di mobile karena tinggi viewport-nya jauh lebih pendek dari desktop.
