...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .entry-content p { margin-top: 0; margin-bottom: 1.5em; line-height: 1.8; }
            .entry-content h1, .entry-content h2, .entry-content h3, .entry-content h4 { font-weight:700; margin-top:1em; margin-bottom:0.75em; }
