        ...
        <div class="flex justify-between h-16">
            <div class="flex justify-between">
                ...
                <div class="hidden sm:flex sm:items-center gap-2 sm:ms-6 w-3/12">
                    <div class="w-full">
                        <a href="https://wa.me/6282123269622" class="w-full bg-[#e05534] border border-[#e05534] text-white px-4 py-2 rounded-full text-xs uppercase font-mono font-bold">Kebutuhan Projek</a>
                    </div>
