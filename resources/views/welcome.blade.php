...
<head>
    ...
    <style>
        ...
        .yen-nav {
            ...
            border-bottom: 1px solid rgba(224, 85, 52, 0.7);
        ...
        .yen-nav-links a:hover {
            color: #fed7aa;
        }

        /* Active desktop link from Jetstream (border-indigo-400) -> Yen orange */
        .yen-nav-links a.border-indigo-400 {
        ...
        .yen-mobile-nav a:hover {
            background-color: rgba(224, 85, 52, 0.18);
            color: #fed7aa;
        }

        /* Active mobile link from Jetstream (border-indigo-400) -> Yen orange */
        .yen-mobile-nav a.border-indigo-400 {
            border-color: #e05534 !important;
            background-color: rgba(224, 85, 52, 0.25) !important;
            color: #fed7aa !important;
        }
        ...
        .yen-mobile-auth .text-gray-800,
        .yen-mobile-auth .text-gray-500 {
            color: #f9fafb;
        }
    ...
    <div class="relative" style="margin-top: 3.2rem">
        ...
        <div class="w-full h-screen grid content-center p-8 text-white absolute top-0 left-0">
            <div class="absolute w-full z-40 top-0 start-0">
                <nav x-data="{ open: false }" class="yen-nav text-white">
                    ...
                    <div class="mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="flex justify-between h-16">
                            <div class="flex justify-between">
                                ...
                                <!-- Navigation Links -->
                                <div class="w-1/2 items-center justify-center hidden space-x-8 sm:-my-px sm:ms-10 sm:flex font-d-din uppercase yen-nav-links">
                    ...
                    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                        <div class="pt-2 pb-3 space-y-1 yen-mobile-nav">
                            ...
                            <hr>
                            <x-responsive-nav-link href="https://wa.me/6282123269622" target="_blank" :active="request()->routeIs('blog')" class="yen-mobile-cta font-mono font-extrabold">
                                {{ __('Kebutuhan Projek') }}
                            </x-responsive-nav-link>
                        </div>
                        <!-- Responsive Settings Options -->
                        @auth
                        <div class="pt-2 pb-1 yen-mobile-auth">
                            <div class="px-4">
                            ...
                            <div class="mt-3 space-y-1">
                                ...
                                <x-responsive-nav-link :href="route('loyalty.promotion-program')">
                                    {{ __('Loyalty Program') }}
                                </x-responsive-nav-link>
                                @if(auth()->user()->is_manager)
